...
/******/ 		return __webpack_require__.p + "js/" + ({"Actions~Rules":"Actions~Rules","Actions":"Actions","Rules":"Rules","ListRules":"ListRules"}[chunkId]||chunkId) + ".js"
/******/ 	}
/******/
...
/******/ 				var href = "css/" + ({"Actions~Rules":"Actions~Rules","Actions":"Actions","Rules":"Rules","ListRules":"ListRules"}[chunkId]||chunkId) + ".css";
...
var Actions = (0, _asyncComponent2.default)(function () {
    return Promise.all(/*! import() | Actions */[__webpack_require__.e("Actions~Rules"), __webpack_require__.e("Actions")]).then(__webpack_require__.t.bind(null, /*! ./SmartComponents/Actions/Actions */ "./src/SmartComponents/Actions/Actions.js", 7));
});
var Rules = (0, _asyncComponent2.default)(function () {
    return Promise.all(/*! import() | Rules */[__webpack_require__.e("Actions~Rules"), __webpack_require__.e("Rules")]).then(__webpack_require__.t.bind(null, /*! ./PresentationalComponents/Rules/Rules */ "./src/PresentationalComponents/Rules/Rules.js", 7));
});
var paths = {
    actions: '/actions',
    rules: '/rules'
...
var Routes = exports.Routes = function Routes(props) {
    ...
    return _react2.default.createElement(
        ...
        null,
        _react2.default.createElement(InsightsRoute, { exact: true, path: paths.actions, component: Actions, rootClass: 'actions' }),
