.ins-c-line {
  border: 0.01rem solid var(--pf-global--BorderColor--100);
}
...
.ins-c-rule-details__stack .pf-c-content {
...
.ins-c-severity-line .ins-l-title {
  width: 115px;
}

.ins-c-severity-line .ins-l-title span {
  color: var(--inc-c-severity-line-text);
  font-size: var(--pf-global--FontSize--sm);
}

.ins-c-severity-line .ins-l-chart {
  position: relative;
}

.ins-c-severity-line .ins-l-chart svg {
  overflow: visible;
}

.ins-c-severity-line .ins-l-chart svg .horizontal {
  stroke: var(--inc-c-severity-line-base);
  stroke-width: 2px;
}

.ins-c-severity-line .ins-l-chart svg .vertical {
  stroke: var(--inc-c-severity-line-base);
  stroke-width: 1px;
}

.ins-c-severity-line .ins-l-chart svg .dataline-1 {
  stroke: var(--ins-c-severity-line-low);
  fill: var(--ins-c-severity-line-low);
  stroke-width: 4px;
}

.ins-c-severity-line .ins-l-chart svg .dataline-2 {
  stroke: var(--ins-c-severity-line-moderate);
  fill: var(--ins-c-severity-line-moderate);
  stroke-width: 4px;
}

.ins-c-severity-line .ins-l-chart svg .dataline-3 {
  stroke: var(--ins-c-severity-line-high);
  fill: var(--ins-c-severity-line-high);
  stroke-width: 4px;
}

.ins-c-severity-line .ins-l-chart svg .dataline-4 {
...
.ratingSpanOverride button {
  padding: 8px;
}
.ins-c-generic__override p {
  margin-top: 0;
