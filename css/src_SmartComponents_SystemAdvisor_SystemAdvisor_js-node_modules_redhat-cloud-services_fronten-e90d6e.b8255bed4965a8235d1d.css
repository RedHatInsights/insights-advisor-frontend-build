.advisor .ins-c-inventory-insights__overrides .adv-c-card-empty-rule div, .inventory .ins-c-inventory-insights__overrides .adv-c-card-empty-rule div {
  text-align: center;
}
.advisor .ins-c-inventory-insights__overrides .successColorOverride, .inventory .ins-c-inventory-insights__overrides .successColorOverride {
  color: var(--pf-global--success-color--100);
}
.advisor .ins-c-inventory-insights__overrides .chartSpikeIconColor, .inventory .ins-c-inventory-insights__overrides .chartSpikeIconColor {
  color: var(--pf-global--primary-color--100);
}
.advisor .ins-c-inventory-insights__overrides .pf-c-clipboard-copy__group-copy, .inventory .ins-c-inventory-insights__overrides .pf-c-clipboard-copy__group-copy {
  background-color: var(--pf-global--BackgroundColor--100);
}
.advisor .ins-c-inventory-insights__overrides .pf-l-stack, .inventory .ins-c-inventory-insights__overrides .pf-l-stack {
  color: var(--pf-c-empty-state__body--Color);
}
.advisor .ins-c-inventory-insights__overrides .ins-c-insights__check, .inventory .ins-c-inventory-insights__overrides .ins-c-insights__check {
  color: var(--pf-global--success-color--200);
}
.advisor .ins-c-inventory-insights__overrides .ins-c-background__default, .inventory .ins-c-inventory-insights__overrides .ins-c-background__default {
  color: var(--pf-global--BackgroundColor--100);
}
.advisor .ins-c-inventory-insights__overrides .ins-c-center-text, .inventory .ins-c-inventory-insights__overrides .ins-c-center-text {
  text-align: center;
}
.advisor .incidentLabel, .inventory .incidentLabel {
  background-color: rgb(250, 234, 232) !important;
}
.advisor .pf-c-label, .inventory .pf-c-label {
  margin-right: var(--pf-global--spacer--xs);
}
.advisor .adv-c-label-incident, .inventory .adv-c-label-incident {
  margin: 0 5px;
}
...
.ins-c-report-details__cards-stack p,
.ins-c-report-details__cards-stack ul,
.ins-c-report-details__cards-stack ol,
.ins-c-report-details__cards-stack li,
.ins-c-report-details__cards-stack dl,
.ins-c-report-details__cards-stack dt,
.ins-c-report-details__cards-stack dd,
.ins-c-report-details__cards-stack blockquote,
.ins-c-report-details__cards-stack figure,
.ins-c-report-details__cards-stack fieldset,
.ins-c-report-details__cards-stack legend,
.ins-c-report-details__cards-stack textarea,
.ins-c-report-details__cards-stack iframe,
.ins-c-report-details__cards-stack hr {
  margin: revert;
  padding: revert;
}

.ins-c-report-details__cards-stack h1,
.ins-c-report-details__cards-stack h2,
.ins-c-report-details__cards-stack h3,
.ins-c-report-details__cards-stack h4,
.ins-c-report-details__cards-stack h5,
.ins-c-report-details__cards-stack h6 {
...
.ins-c-report-details__cards-stack h4, .ins-c-report-details__cards-stack h5, .ins-c-report-details__cards-stack h6 {
